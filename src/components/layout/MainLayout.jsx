...
const PAGE_TITLE_OVERRIDES = [
  ...
  ['/master/item-group', 'Item Group Master'],
  ['/master/store', 'Store Master'],
  ...
  ['/master/customer/view', 'Customer List'],
  ['/master/customer', 'Customer'],
  ['/master/supplier/view', 'Supplier'],
  ['/subcontractor/dc', 'Subcontractor DC'],
  ['/subcontractor', 'Subcontractor List'],
  ['/crm/leads', 'CRM Leads'],
  ...
  ['/maintenance/bin', 'Bin'],
  ['/planning/uom', 'UOM'],
  ['/process/so', 'Sales Order'],
  ['/process/wo', 'Work Order'],
